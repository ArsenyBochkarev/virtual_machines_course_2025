// This was copy-pasted from Lama/runtime/runtime.c,
// but with removed assert for `__builtin_frame_address(0)` usage.
// When lamai is built, it is copied straight to Lama/runtime/runtime.c,
// removing C call stack requirement from GC (since we use virtual stack)
