...
typedef struct {
    ...
    int ip;
    int current_line;
    std::vector<Value> temp_captured;
} VMState;
            ...
            case 5:
                switch (low) {
                    ...
                    case 3: { // BEGIN, CBEGIN
                        ...
                        if (low == 3) { // CBEGIN
                            for (int i = 0; i < vm.temp_captured.size(); i++)
                                new_frame.add_captured(vm.temp_captured[i]);
                            // Очищаем временное хранилище
                            vm.temp_captured.clear();
                        }
                    ...
                    case 5: { // CALLC
                        ...
                        current_frame->captured_vars.clear();
